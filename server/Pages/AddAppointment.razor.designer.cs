...
{
    public partial class AddAppointmentComponent : ComponentBase, IDisposable
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            appointment = new RecoCms6.Models.RecoDb.Appointment(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(RecoCms6.Models.RecoDb.Appointment args)
        {
            try
            {
                var recoDbCreateAppointmentResult = await RecoDb.CreateAppointment(appointment);
                DialogService.Close(appointment);
            }
            catch (System.Exception recoDbCreateAppointmentException)
            {
