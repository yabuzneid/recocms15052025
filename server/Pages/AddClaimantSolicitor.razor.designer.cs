...
{
    public partial class AddClaimantSolicitorComponent : ComponentBase, IDisposable
    {
        ...
        {
            claimantsolicitor = new RecoCms6.Models.RecoDb.ClaimantSolicitor(){};
        ...
        {
            claimantsolicitor.ID = Guid.NewGuid();

            try
            {
                var recoDbCreateClaimantSolicitorResult = await RecoDb.CreateClaimantSolicitor(claimantsolicitor);
                DialogService.Close(claimantsolicitor);
            }
            catch (System.Exception recoDbCreateClaimantSolicitorException)
            {
