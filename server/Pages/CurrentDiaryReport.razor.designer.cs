...
{
    public partial class CurrentDiaryReportComponent : ComponentBase, IDisposable
    {
        ...
        IEnumerable<RecoCms6.Models.RecoDb.CurrentDiaryReport> _getDataList;
        protected IEnumerable<RecoCms6.Models.RecoDb.CurrentDiaryReport> getDataList
        {
            get
            {
                return _getDataList;
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            var recoDbGetCurrentDiaryReportsResult = await RecoDb.GetCurrentDiaryReports(new Query() { OrderBy = $"ClaimNum asc" });
            getDataList = recoDbGetCurrentDiaryReportsResult;
        }
