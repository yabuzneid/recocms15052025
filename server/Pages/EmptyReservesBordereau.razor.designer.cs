...
{
    public partial class EmptyReservesBordereauComponent : ComponentBase, IDisposable
    {
        ...
        IEnumerable<RecoCms6.Models.RecoDb.EmptyReserveBordereau> _getDataList;
        protected IEnumerable<RecoCms6.Models.RecoDb.EmptyReserveBordereau> getDataList
        {
            get
            {
                return _getDataList;
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            var recoDbGetEmptyReserveBordereausResult = await RecoDb.GetEmptyReserveBordereaus();
            getDataList = recoDbGetEmptyReserveBordereausResult;
        }
