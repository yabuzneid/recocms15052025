...
{
    public partial class FullBordereauComponent : ComponentBase, IDisposable
    {
        ...
        IEnumerable<RecoCms6.Models.RecoDb.FullBordereau> _getDataList;
        protected IEnumerable<RecoCms6.Models.RecoDb.FullBordereau> getDataList
        {
            get
            {
                return _getDataList;
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            {
                var recoDbGetFullBordereausResult = await RecoDb.GetFullBordereaus($"{selectedReportDate}");
                getDataList = recoDbGetFullBordereausResult;
            }
        }
