...
{
    public partial class LargeLossBordereauComponent : ComponentBase, IDisposable
    {
        ...
        IEnumerable<RecoCms6.Models.RecoDb.LargeLossBordereau> _getDataList;
        protected IEnumerable<RecoCms6.Models.RecoDb.LargeLossBordereau> getDataList
        {
            get
            {
                return _getDataList;
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            var recoDbGetLargeLossBordereausResult = await RecoDb.GetLargeLossBordereaus($"{selectedReportDate}");
            getDataList = recoDbGetLargeLossBordereausResult;
        }
