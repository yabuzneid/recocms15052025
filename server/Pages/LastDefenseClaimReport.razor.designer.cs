...
{
    public partial class LastDefenseClaimReportComponent : ComponentBase, IDisposable
    {
        ...
        IEnumerable<RecoCms6.Models.RecoDb.LastDefenceClaimReport> _getDataList;
        protected IEnumerable<RecoCms6.Models.RecoDb.LastDefenceClaimReport> getDataList
        {
            get
            {
                return _getDataList;
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            var recoDbGetLastDefenceClaimReportsResult = await RecoDb.GetLastDefenceClaimReports();
            getDataList = recoDbGetLastDefenceClaimReportsResult;
        }
        ...
        {
            filename = "largelossbordereau" + DateTime.Now.ToString("yyyyMMddTHHmmss");
