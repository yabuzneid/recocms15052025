...
{
    public partial class NoActiveDiaryReportComponent : ComponentBase, IDisposable
    {
        ...
        IEnumerable<RecoCms6.Models.RecoDb.NoActiveDiaryBordereau> _getDataList;
        protected IEnumerable<RecoCms6.Models.RecoDb.NoActiveDiaryBordereau> getDataList
        {
            get
            {
                return _getDataList;
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            var recoDbGetNoActiveDiaryBordereausResult = await RecoDb.GetNoActiveDiaryBordereaus();
            getDataList = recoDbGetNoActiveDiaryBordereausResult;
        }
